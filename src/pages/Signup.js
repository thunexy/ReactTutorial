            ...
            <ScrollView>
                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.passwordRider}>
                        <Text style={{fontWeight: "bold", fontSize: 18, color: "#000"}}>Password Requirements:</Text>
                        <Text style={styles.riderText}>Minimum of 8 characters. At least 1 letter and 1 number</Text>
                    </View>
                    ...
                    <TextInput style={styles.inputField} placeholder="Referral Code"/>
                    ...
                    <View style={{
                        ...
                        <View style={{width: "100%", flexDirection: "row", paddingRight: 16}}>
                            <CheckBox checkedColor="red"/>
                            <Text style={{fontSize: 14}}>By clicking Sign Up, you agree to our Terms and confirm that
                                you have read our Privacy Policy</Text>
                        </View>
                    </View>
